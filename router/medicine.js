...
medicineRouter.delete(
  "/image/delete/:id",
  /* verifyToken, */ deleteMedicineImage
); // id should be of image
...
medicineRouter.delete(
  "/size/delete/:id",
  /* verifyToken, */ deleteMedicineSize
); // id should be of size
