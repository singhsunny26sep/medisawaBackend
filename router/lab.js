...
const { getAllTests, getTestByLab, addTest, updateTest, deleteTest, getByBookingId, getByPatientId, getByDoctorId, getTestLabPatient, getByLabId, uploadReport, updateReport, deleteReport, mostTakenTest, getPatientList, bookTest } = require('../controller/Lab');
