...
const { addBooking, getBookingData, getBookingByPatientId, bookingStatusChange, cancelBooking, getBookingWithPatientAndDoctorId, getDoctorByIdBooking, getAllBookings, getBookingDoctor, addBookingByReceptionist, getPrescriptions } = require('../controller/booking')
...
bookingRouter.get('/patientBooking/patient/:id', verifyToken, getBookingByPatientId)

bookingRouter.get('/doctorBookings/:doctorId', verifyToken, getBookingData)

bookingRouter.get('/booking/history/:patientId/:doctorId', verifyToken, getBookingWithPatientAndDoctorId)

bookingRouter.post('/book/appointment/:patientId', verifyToken, addBooking)

bookingRouter.post('/book/receptionist/appointment', verifyToken, addBookingByReceptionist)
