...
const { addProfile, getAllDoctors, searchDoctorByCategoryOrbySpacailization, getDoctorProfile, addReceptOfPatient, addLabTest, topRatedDoctor, searchBySymptom } = require('../controller/doctor')
