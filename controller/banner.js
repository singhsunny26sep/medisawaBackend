...
exports.addBanner = async (req, res) => {
  ...
  try {
    ...
    if (checkBanner) {
      return res
        .status(400)
        .json({ success: false, msg: "Banner already exists!" });
    }
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Banner added successfully!", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to add Banner!" });
  } catch (error) {
...
exports.updateBanner = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to update Banner!" });
  } catch (error) {
...
exports.deleteBanner = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to delete Banner!" });
  } catch (error) {
