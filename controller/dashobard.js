...
const { getBookingStats, getTodaysAppointments, getLabTestStatusCounts, getTodaysLabTests, getTotalRevenue, getTotalSellsAndRevenue, getTodaysSellsAndRevenue } = require("../utils/dashobard");
...
exports.dashobard = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            success: true, statusCounts, todaysAppointments, selles: analytics,
