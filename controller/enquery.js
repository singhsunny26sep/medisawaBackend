...
exports.addEnquery = async (req, res) => {
  ...
  try {
    const result = await Enquery.create({
      name,
      email,
      mobile,
      location,
    ...
    return res
      .status(200)
      .json({ success: true, msg: "Enquery added successfully!", result });
  } catch (error) {
...
exports.updateEnquery = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Enquery updated successfully!", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to update enquery!" });
  } catch (error) {
...
exports.deleteEnquery = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Enquery deleted successfully!", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to delete enquery!" });
  } catch (error) {
