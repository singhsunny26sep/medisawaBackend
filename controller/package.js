...
exports.getAllPackages = async (req, res) => {
  ...
  try {
    if (id) {
      ...
      return res
        .status(404)
        .json({ success: false, msg: "No packages found!" });
    }
...
exports.createPackage = async (req, res) => {
  ...
  try {
    ...
    if (checkPackage) {
      return res
        .status(400)
        .json({ success: false, msg: "Package already exists!" });
    }
    if (price < 0) {
      return res
        .status(400)
        .json({ success: false, msg: "Price cannot be negative!" });
    }
...
exports.updatePackage = async (req, res) => {
  ...
  try {
    ...
    if (!checkPackage) {
      return res
        .status(404)
        .json({ success: false, msg: "Package not found!" });
    }
    if (price < 0) {
      return res
        .status(400)
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Package updated successfully!", result });
    }
    return res
      .status(400)
      .json({ msg: "Failed to update package!", success: false });
  } catch (error) {
...
exports.addOrRemoveTestIdToPackage = async (req, res) => {
  ...
  try {
    ...
    if (!test) {
      return res
        .status(400)
        .json({ success: false, msg: "Test ID is required!" });
    }
...
exports.deletePackage = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Package deleted successfully!", result });
    }
    return res
      .status(400)
      .json({ msg: "Failed to delete package!", success: false });
  } catch (error) {
...
exports.bookPackage = async (req, res) => {
  ...
  try {
    ...
    const result = new PackageBook({
      userId: userId,
      patientId,
      packageId: id,
      amount: checkPackage?.price,
      paidAmount,
      title: checkPackage?.title,
    });
    ...
    if (!tests || tests.length === 0) {
      return res
        .status(400)
        .json({ success: false, msg: "No tests found in the package" });
    }
    ...
    return res
      .status(200)
      .json({ success: true, msg: "Package booked successfully!", result });
  } catch (error) {
