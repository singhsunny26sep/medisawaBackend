...
exports.getAllMedicine = async (req, res) => {
  ...
  try {
    if (id) {
      ...
      return res
        .status(404)
        .json({ msg: "No medicine found!", success: false });
    }
...
exports.getOfferMedicines = async (req, res) => {
  try {
    ...
    const result = await Medicine.find({ isOffer: true })
      .sort({ createdAt: -1 })
      .populate("images", "-__v")
      .populate("category", "-__v")
      .populate("subCategory", "-__v")
...
exports.getSubCategoryMedicines = async (req, res) => {
  const id = req.params?.id;
  try {
    const result = await Medicine.find({ subCategory: id })
      .sort({ createdAt: -1 })
      .populate("images", "-__v")
      .populate("category", "-__v")
      .populate("subCategory", "-__v")
...
exports.getByBrandMedicines = async (req, res) => {
  const id = req.params?.id;
  try {
    const result = await Medicine.find({ brand: id })
      .sort({ createdAt: -1 })
      .populate("images", "-__v")
      .populate("category", "-__v")
      .populate("subCategory", "-__v")
...
exports.addMedicine = async (req, res) => {
  ...
  try {
    ...
    if (category && !(await Category.findById(category))) {
      return res
        .status(404)
        .json({ msg: "No category found!", success: false });
    }
    if (subCategory && !(await SubCategory.findById(subCategory))) {
      return res
        .status(404)
        .json({ msg: "No subcategory found!", success: false });
    }
    ...
    return res
      .status(200)
      .json({ success: true, msg: "Medicine added successfully!", result });
  } catch (error) {
...
exports.updateMedicineImage = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Image updated successfully", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to update image!" });
  } catch (error) {
...
exports.deleteMedicineImage = async (req, res) => {
  ...
  try {
    ...
    await Medicine.findByIdAndUpdate(checkImage?.medicine, {
      $pull: { images: id },
    });
    if (checkImage.image) {
      await deleteFromCloudinary(checkImage?.image);
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Image deleted successfully", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to delete image!" });
  } catch (error) {
...
exports.addMedicineImage = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Image added successfully", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to add image!" });
  } catch (error) {
...
exports.addMedicineSize = async (req, res) => {
  ...
  try {
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Size added successfully", result });
    }
...
exports.deleteMedicineSize = async (req, res) => {
  ...
  try {
    ...
    await Medicine.findByIdAndUpdate(checkSize?.medicine, {
      $pull: { size: id },
    });
    ...
    if (result) {
      return res
        .status(200)
        .json({ success: true, msg: "Size deleted successfully", result });
    }
    return res
      .status(400)
      .json({ success: false, msg: "Failed to delete size!" });
  } catch (error) {
...
exports.getMedicinesByCategoriesWise = async (req, res) => {
  try {
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to get medicines!" });
  } catch (error) {
