...
exports.getDepartments = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json({ success: false, msg: "Departments not found!" });
  } catch (error) {
...
exports.getAllPagination = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(404)
      .json({ success: false, msg: "No departments found!" });
  } catch (error) {
...
exports.addDepartment = async (req, res) => {
  ...
  try {
    ...
    if (checkDepartments) {
      return res
        .status(400)
        .json({ success: false, msg: "Department already exists!" });
    }
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to add department!" });
  } catch (error) {
...
exports.updateDepartment = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to update department!" });
  } catch (error) {
...
exports.deleteDepartment = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ success: false, msg: "Failed to delete department!" });
  } catch (error) {
